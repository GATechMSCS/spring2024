...
#                              [0]*99744),
#               'pi': list(ql_bj_gamma[0.9]['pi'].values())+[0]*99744,
...
#                              [0]*99744),
#               'pi': list(ql_bj_gamma[0.99]['pi'].values())+[0]*99744,
...
#                              [0]*99744),
#               'pi': list(ql_bj_gamma[0.999]['pi'].values())+[0]*99744,
...
# new_fields = {'V': np.append(ql_bj_edr[0.8]['V'],
#                              [0]*99984),
#               'pi': list(ql_bj_edr[0.8]['pi'].values())+[0]*99984,
#               'episode_rewards': ql_bj_edr[0.8]['episode_rewards'],
#               'average_episode_rewards': np.append(ql_bj_edr[0.8]['average_episode_rewards'],
#                                                   [0]*99999)}
# pd.DataFrame(data=new_fields).to_csv(path_or_buf=pathql+'/ql_bj_edr8.csv')

# new_fields = {'V': np.append(ql_bj_edr[0.9]['V'],
#                              [0]*99984),
#               'pi': list(ql_bj_edr[0.9]['pi'].values())+[0]*99984,
...
#                              [0]*99984),
#               'pi': list(ql_bj_edr[0.99]['pi'].values())+[0]*99984,
...
#                              [0]*99984),
#               'pi': list(ql_bj_alpha[0.3]['pi'].values())+[0]*99984,
...
#                              [0]*99984),
#               'pi': list(ql_bj_alpha[0.5]['pi'].values())+[0]*99984,
...
#                              [0]*99984),
#               'pi': list(ql_bj_alpha[0.7]['pi'].values())+[0]*99984,
...
################ GAMMA ##################
# bj_pi_gam = run_pi_search(process=frozenlakeL,
#                   gamma=gamma_pi_bj,
#                   n_iters=iters_pi_bj)

# new_fields = {'V': np.append(bj_pi_gam[0.9]['V'],
#                              [0]*99744),
#               'pi': list(bj_pi_gam[0.9]['pi'].values())+[0]*99744,
#               'episode_rewards': bj_pi_gam[0.9]['episode_rewards'],
#               'average_episode_rewards': np.append(bj_pi_gam[0.9]['average_episode_rewards'],
#                                                   [0]*99999)}
# pd.DataFrame(data=new_fields).to_csv(path_or_buf=pathpi+'/bj_pi_gam9.csv')

# new_fields = {'V': np.append(bj_pi_gam[0.99]['V'],
#                              [0]*99744),
#               'pi': list(bj_pi_gam[0.99]['pi'].values())+[0]*99744,
#               'episode_rewards': bj_pi_gam[0.99]['episode_rewards'],
#               'average_episode_rewards': np.append(bj_pi_gam[0.99]['average_episode_rewards'],
#                                                   [0]*99999)}
# pd.DataFrame(data=new_fields).to_csv(path_or_buf=pathpi+'/bj_pi_gam99.csv')

# new_fields = {'V': np.append(bj_pi_gam[0.999]['V'],
#                              [0]*99744),
#               'pi': list(bj_pi_gam[0.999]['pi'].values())+[0]*99744,
#               'episode_rewards': bj_pi_gam[0.999]['episode_rewards'],
#               'average_episode_rewards': np.append(bj_pi_gam[0.999]['average_episode_rewards'],
#                                                   [0]*99999)}
...
################ GAMMA ##################
# bj_vi_gam = run_vi_search(process=frozenlakeL,
#                   gamma=gamma_vi_bj,
#                   n_iters=iters_vi_bj)

# new_fields = {'V': np.append(bj_vi_gam[0.9]['V'],
#                              [0]*99744),
#               'pi': list(bj_vi_gam[0.9]['pi'].values())+[0]*99744,
#               'episode_rewards': bj_vi_gam[0.9]['episode_rewards'],
#               'average_episode_rewards': np.append(bj_vi_gam[0.9]['average_episode_rewards'],
#                                                   [0]*99999)}
# pd.DataFrame(data=new_fields).to_csv(path_or_buf=pathvi+'/bj_vi_gam9.csv')

# new_fields = {'V': np.append(bj_vi_gam[0.99]['V'],
#                              [0]*99744),
#               'pi': list(bj_vi_gam[0.99]['pi'].values())+[0]*99744,
#               'episode_rewards': bj_vi_gam[0.99]['episode_rewards'],
#               'average_episode_rewards': np.append(bj_vi_gam[0.99]['average_episode_rewards'],
#                                                   [0]*99999)}
# pd.DataFrame(data=new_fields).to_csv(path_or_buf=pathvi+'/bj_vi_gam99.csv')

# new_fields = {'V': np.append(bj_vi_gam[0.999]['V'],
#                              [0]*99744),
#               'pi': list(bj_vi_gam[0.999]['pi'].values())+[0]*99744,
#               'episode_rewards': bj_vi_gam[0.999]['episode_rewards'],
#               'average_episode_rewards': np.append(bj_vi_gam[0.999]['average_episode_rewards'],
#                                                   [0]*99999)}
# pd.DataFrame(data=new_fields).to_csv(path_or_buf=pathvi+'/bj_vi_gam999.csv')

################ THETA ##################
# bj_vi_theta = run_vi_search(process=frozenlakeL,
#                   theta=theta_vi_bj,
#                   n_iters=iters_vi_bj)

# new_fields = {'V': np.append(bj_vi_theta[1e-5]['V'],
#                              [0]*99744),
#               'pi': list(bj_vi_theta[1e-5]['pi'].values())+[0]*99744,
...
#                              [0]*99744),
#               'pi': list(bj_vi_theta[1e-7]['pi'].values())+[0]*99744,
...
#                              [0]*99744),
#               'pi': list(bj_vi_theta[1e-9]['pi'].values())+[0]*99744,

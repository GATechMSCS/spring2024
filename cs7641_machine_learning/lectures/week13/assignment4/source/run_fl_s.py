...
new_fields = {'V': np.append(ql_fl_S_gamma[0.9]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_gamma[0.9]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_gamma[0.99]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_gamma[0.99]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_gamma[0.999]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_gamma[0.999]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_edr[0.8]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_edr[0.8]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_edr[0.9]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_edr[0.9]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_edr[0.99]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_edr[0.99]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_alpha[0.3]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_alpha[0.3]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_alpha[0.5]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_alpha[0.5]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(ql_fl_S_alpha[0.7]['V'],
                             [0]*99984),
              'pi': list(ql_fl_S_alpha[0.7]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_pi_gam[0.9]['V'],
                             [0]*99984),
              'pi': list(fl_S_pi_gam[0.9]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_pi_gam[0.99]['V'],
                             [0]*99984),
              'pi': list(fl_S_pi_gam[0.99]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_pi_gam[0.999]['V'],
                             [0]*99984),
              'pi': list(fl_S_pi_gam[0.999]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_pi_theta[1e-5]['V'],
                             [0]*99984),
              'pi': list(fl_S_pi_theta[1e-5]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_pi_theta[1e-7]['V'],
                             [0]*99984),
              'pi': list(fl_S_pi_theta[1e-7]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_pi_theta[1e-9]['V'],
                             [0]*99984),
              'pi': list(fl_S_pi_theta[1e-9]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_vi_gam[0.9]['V'],
                             [0]*99984),
              'pi': list(fl_S_vi_gam[0.9]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_vi_gam[0.99]['V'],
                             [0]*99984),
              'pi': list(fl_S_vi_gam[0.99]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_vi_gam[0.999]['V'],
                             [0]*99984),
              'pi': list(fl_S_vi_gam[0.999]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_vi_theta[1e-5]['V'],
                             [0]*99984),
              'pi': list(fl_S_vi_theta[1e-5]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_vi_theta[1e-7]['V'],
                             [0]*99984),
              'pi': list(fl_S_vi_theta[1e-7]['pi'].values())+[0]*99984,
...
new_fields = {'V': np.append(fl_S_vi_theta[1e-9]['V'],
                             [0]*99984),
              'pi': list(fl_S_vi_theta[1e-9]['pi'].values())+[0]*99984,
